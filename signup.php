    ...
    <body id="_6">
            ...
            <div id="sf">
                <center>
                    <div class="heading"><br><br><br><br>
                        <h1 class="logo"><div id="ntro">Register</div></h1>
                    </div>

                    <form action="<?php echo htmlspecialchars( $_SERVER["PHP_SELF"] ); ?>" method="post" enctype="multipart/form-data">
                        <input name="username" id="user" type="text" title="This will be your parmanent Id." placeholder="Create a your Username" required>
                        <input name="password" id="key" type="password" title="Password must contain at least 8 characters including alphabets,numbers, and symbols." placeholder="Create a your Password" required>
                        ...
                        <input name="email" id="mailbox" type="email" title="Your Email id is in safe hands." placeholder="Enter your Email" required>
                        <i class="material-icons" id="email">mail</i>
                        <i class="material-icons" id="iden">perm_identity</i>

                        <div id="button-block">
                            <center>
                                <div class="buttons"><input name="submit" type="submit" value="Create An Account" class="up-in"id="but"></div>
        ...
        <?php
            ...
            if( isset( $_POST["submit"] ) )
            {
                ...
                $query = "INSERT INTO users values( NULL, '$username', '$password', '$name', '$email', 1,CURRENT_TIMESTAMP )";
